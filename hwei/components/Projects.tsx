...
const Projects = () => {
  ...
  const projects: Project[] = [
      ...
      },
    {
      id: 2,
      title: 'ByTech',
      description: 'An AI-driven programming classroom for teachers to publish and manage their programming lessons. This website allows teachers to create, edit, and publish programming lessons, and students to learn and practice programming skills.',
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="mb-16">
            <div className="grid lg:grid-cols-2 gap-8">
              {projects
                .map((project) => (
                  <div key={project.id} className="bg-white dark:bg-slate-700 rounded-xl shadow-lg overflow-hidden card-hover">
                    ...
                    <div className="p-6">
                      ...
                      <p className="md:flex hidden text-slate-700 dark:text-slate-300 mb-4 leading-relaxed">
                        {project.description}
                      </p>
                      ...
                      <div className="flex gap-4">
                        <a
                          ...
                          className="flex-1 bg-slate-800 dark:bg-slate-700 text-white text-center py-2 px-4 rounded-lg hover:bg-slate-700 dark:hover:bg-slate-600 transition-colors"
                        >
                          View Code
                        </a>
                        {project.liveUrl && (
