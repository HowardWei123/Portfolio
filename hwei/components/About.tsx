  ...
  return (
    <section id="about" className="py-20">
      <div className="container-max section-padding">
        <div className="backdrop-blur-xs border border-cyan-400/50 rounded-2xl p-10 backdrop-opacity-80">
          {/* Section Header */}
          <div className="text-center mb-16">
            ...
            <a
              ...
              className="inline-block mt-6 px-6 py-3 border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
              download
            >
              Download Resume
            </a>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              {/* Education Card */}
              <div className="bg-slate-700/60 p-6 rounded-xl shadow-lg card-hover">
