  ...
  return (
    <div className="absolute top-4 right-4 text-blue-400 z-10">
      <button
        ...
        className="bg-black/30 backdrop-blur-sm border border-blue-900 p-2 rounded-md hover:bg-black/50 transition-all"
      >
      ...
      <div className={cn(
        "mt-2 bg-black/30 backdrop-blur-sm border border-blue-900 p-4 rounded-md transition-all duration-300",
        isOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
      )}>
        <h3 className="text-sm font-mono mb-4 text-blue-300">J.A.R.V.I.S. CONTROLS</h3>
