        ...
        >
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <div className="flex gap-3 md:gap-4">
                        <a
                          ...
                          className="flex-1 bg-slate-700/60 text-white border border-slate-200 text-center py-2 px-4 text-sm md:text-base rounded-lg hover:bg-slate-200 hover:text-slate-900 transition-colors"
                        >
                          View Code
                        </a>
                        {project.liveUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 bg-blue-600/50 text-white text-center py-2 px-4 text-sm md:text-base rounded-lg hover:bg-blue-700 transition-colors"
                          >
                            Live Demo
                          </a>
                        )}
          ...
          <div className="text-center mt-12 md:mt-16">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-slate-700/60 text-white px-6 py-2 md:px-8 md:py-3 text-sm md:text-base rounded-lg hover:bg-slate-600 transition-colors"
            >
